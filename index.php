            ...
            <div class="row prev-next-margin">
                ...
                <div class="page-wrapper">
                    ...
                    <nav class="paging-nav d-inline-block">
                        <ul>
                            <li class="pg-num active">
                                <a href="#" class="mb-2 pg-btn pg-num-link">1</a>
                            </li>
                            <li class="pg-num">
                                <a href="#" class="mb-2 pg-btn pg-num-link">2</a>
                            </li>
                            <li class="pg-num">
                                <a href="#" class="mb-2 pg-btn pg-num-link">3</a>
                            </li>
                            <li class="pg-num">
                                <a href="#" class="mb-2 pg-btn pg-num-link">4</a>
                            </li>
                        </ul>
                    </nav>
                </div>                
